...
class FacebookLogin
{
	 ...
	 */
	public function __construct($client_id, $client_secret, $return)
	{
	...
	private function verifyLogin()
	{
		...
		$this->user_data = json_decode(file_get_contents(self::PROFILE_URL . '?access_token=' . $this->access_token . '&fields=id,name,email,link,first_name,last_name'));
